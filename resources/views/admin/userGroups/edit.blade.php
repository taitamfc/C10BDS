        ...
        <div class="card-body">
            <form method="post" action="{{route('userGroups.update',$userGroup->id)}}" >
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="tf1"> Chi tiết nhóm</label> <input type="text" name="description" value="{{ $userGroup->description }} " class="form-control"  placeholder="nhập địa chỉ"> <small  class="form-text text-muted"></small>
                    </div>
