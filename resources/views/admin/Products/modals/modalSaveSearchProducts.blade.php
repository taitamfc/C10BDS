<div class="modal fade" id="modalSaveSearchProducts" tabindex="-1" role="dialog" aria-labelledby="modalSaveSearchProductsLabel" aria-hidden="true">
    <!-- .modal-dialog -->
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modalSaveSearchProductsLabel"> Lưu kết quả </h5>
            </div><!-- /.modal-header -->
            <!-- .modal-body -->
