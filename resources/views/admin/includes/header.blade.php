        ...
        <div class="top-bar-list">
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                ...
                <div class="dropdown d-none d-md-flex">
                    ...
                    <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="{{asset('admin/images/avatars/profile.jpg')}}" alt=""></span>
                        <span class="account-summary pr-lg-4 d-none d-lg-block"><a href="{{ route('users.index',$user->id)}}" class="account-name">{{ $user->name}}</a>
                            <span class="account-description">{{ $user->userGroup->name }}</span></span></button>
                    <div class="dropdown-menu">
                        <h6 class="dropdown-header d-none d-md-block d-lg-none"> Beni Arisandi </h6><a class="dropdown-item" href="#"><span class="dropdown-icon oi oi-person"></span> Thông tin cá nhân</a> <a class="dropdown-item" href="{{ route('login') }}"><span class="dropdown-icon oi oi-account-logout"></span>
                            Đăng xuất</a>
                        @endforeach
